...
N.iter <- 10
temp.list <- runif(N.iter,min=10,max=30)
density.list <- runif(N.iter,min=20,max=80)
...
GSA.res <- data.frame(temp=temp.list,density=density.list,P.max,FF.max,K.max)
